    ...
    <section id="soporte" className="bg-gray-950 py-16">
      ...
      <div className="flex">
        ...
        >
          <div className="relative w-30">
            ...
            <input
              ...
              className="w-64 h-14 px-8 py-2 pl-16 bg-gradient-to-r from-[#333333] to-[#4D4D4D] text-white rounded-md focus:outline-none focus:bg-gray-700 mb-4"
          ...
          <textarea
            ...
            name="sms"
            rows="4"
            className="w-64  px-8 py-2 pl-16 bg-gradient-to-r from-[#333333] to-[#4D4D4D] text-white rounded-md focus:outline-none focus:bg-gray-700 mb-4"
            onChange={handleChange}
            value={consultas.sms}
          ></textarea>
          </div>
        ...
        <div className="w-2/3 flex flex-col items-center">
          ...
          />
          <div className="flex space-x-4">{/* Iconos de redes sociales */}</div>
        </div>
      </div>
    </section>
  );
